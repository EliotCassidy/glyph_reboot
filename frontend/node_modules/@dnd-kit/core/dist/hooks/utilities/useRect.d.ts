...
export declare function useRect<T = LayoutRect, U = HTMLElement>(element: U | null, getRect: (element: U) => T, forceRecompute?: boolean): T | null;
export declare function createUseRectFn<T = LayoutRect, U = HTMLElement>(getRect: RectFn<T, U>): (element: U | null, forceRecompute?: boolean | undefined) => T | null;
export {};
